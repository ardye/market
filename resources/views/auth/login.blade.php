...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/adminLTE/plugins/iCheck/square/blue.css') }}">
</head>
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <img src="{{ asset('public/images/'.$setting->logo) }}" alt="Market Logo" width="300">
        </div>
